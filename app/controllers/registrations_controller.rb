class RegistrationsController < Devise::RegistrationsController
  ...
  #   User.assign_roles_to_user(params, @user) if record_status
  #   if record_status.to_s == "false"
  #     if users.present?
  ...
  def view_path(status, user)
    (status.to_s == "true") ? "/dashboard/index" : "/users/sign_up"
  end
  ...
  def account_update_params
    params.require(:user).permit(:id, :user_name, :email, :password, :password_confirmation, :current_password)
  end
end